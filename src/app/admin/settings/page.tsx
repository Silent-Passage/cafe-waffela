...
const fields: {
...
}[] = [
  {
    name: "heroTagline",
    label: "Hero Tagline",
    placeholder: "Hausgemachte Waffeln....",
  },
  {
    name: "instagramHandle",
    label: "Instagram Handle",
    placeholder: "@waffela_lustenau",
  },
  {
  ...
  },
  {
    ...
    placeholder: "Neudorfstraße 38, 6890 Lustenau",
  },
  {
    name: "googleMapsUrl",
    label: "Google Maps Link",
    hint: "Link to Google Maps location",
  },
  {
    name: "googleMapsEmbedUrl",
    label: "Google Maps Embed URL",
    hint: "The src URL from a Google Maps embed iframe.",
  },
  { name: "phone", label: "Phone Number", placeholder: "+43..." },
  {
    name: "whatsappNumber",
    label: "WhatsApp Number",
    placeholder: "+436600000000",
    hint: "International format without spaces.",
  },
  {
    name: "contactEmail",
    label: "Contact Email",
    type: "email",
    placeholder: "info@cafewaffela.at",
  },
  {
    name: "facebookUrl",
    label: "Facebook URL",
  ...
  },
  {
    ...
    label: "Foodora URL",
    type: "url",
    placeholder: "https://foodora.at/...",
  },
  {
    name: "lieferandoUrl",
    label: "Lieferando URL",
    type: "url",
    placeholder: "https://lieferando.at/...",
  },
];
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Global configuration for the public cafe website"
      />
